  ...
  const fetchBuilders = () => {
    ...
    fetch(`/api/builders${params}`)
      ...
      .then((data) => {
        ...
        else setError(data.error || "Erro ao carregar construtoras");
      })
      .catch(() => setError("Erro ao carregar construtoras"))
    ...
    <main className="min-h-screen bg-[#0f0f0f] p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            <h1 className="text-2xl font-medium text-white">Construtoras</h1>
            <p className="text-sm text-gray-500 mt-1">
              Gerencie as construtoras parceiras.
            </p>
          </div>
          <Link
            href="/builders/new"
        ...
        {loading ? (
          ...
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-3xl p-12 text-center">
            ...
            <p className="text-sm text-gray-600">
              Crie uma nova construtora para começar.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {builders.map((builder) => {
              const isActive = builder.active;
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-[#2a2a2a] flex items-center gap-2 text-sm text-gray-500">
                      ...
                      {builder._count?.projects || 0} projetos
                    </div>
                  </div>
                </div>
              );
