      ...
      <main className="min-h-screen bg-[#0f0f0f] p-6 md:p-8">
        <div className="max-w-6xl mx-auto">
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-3xl p-8 text-center">
            <p className="text-rose-400">{error || "Construtora não encontrada"}</p>
            <button
              onClick={() => router.back()}
          ...
          <div className="p-6 md:p-8">
            <div className="flex items-start justify-between">
              <div>
                ...
                {builder.legalName && (
                  <p className="text-gray-400 mt-1">{builder.legalName}</p>
                )}
              </div>
              <Link
            ...
            <div className="flex flex-wrap gap-4 mt-4 text-sm text-gray-400">
              ...
              <span className="flex items-center gap-1.5">
                ...
                {builder.projects.length} projetos
              </span>
            </div>

            {builder.description && (
              <p className="text-sm text-gray-400 mt-4">{builder.description}</p>
            )}
          </div>
        </div>
